...
class MainTableViewController: UITableViewController {
    ...
    fileprivate func setUpFetchedResultController() {
        ...
        fetchedResultController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: dataController.viewContext, sectionNameKeyPath: nil, cacheName: "Noticias01")
